...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 w-full bg-white/70 backdrop-blur-lg z-50 border-b border-gray-200/50">
      ...
      <div className={`${isMenuOpen ? 'block' : 'hidden'} md:hidden`}>
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          <Link
            href="#demo"
            className="block w-full text-center bg-blue-600 text-white px-4 py-2 rounded-lg text-base font-medium hover:bg-blue-700"
          >
            Coba Demo
          </Link>
        </div>
